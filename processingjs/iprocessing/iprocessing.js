/*
 * IProcessing.js - Michael Schieben (http://www.rockitbaby.de)
 * modification on event handlers for use on iPhone
 *
 * All credits to John Resig!
 *
...
this.IProcessing = function IProcessing( aElement, aCode ) {
...
var parse = IProcessing.parse = function parse( aCode, p ) {
